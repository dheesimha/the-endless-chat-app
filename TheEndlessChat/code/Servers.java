...
public class Servers implements ActionListener{
    ...
    Servers(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("ChattingApplication/Harvey Spectre.jpg"));
       Image i5 = i4.getImage().getScaledInstance(63, 63, Image.SCALE_DEFAULT);
       ImageIcon i6 = new ImageIcon(i5);
       JLabel l2 = new JLabel(i6);
       l2.setBounds(40, 5, 63, 63);
       p1.add(l2);
       ...
       l7.setBounds(423, 17, 10, 25);
       p1.add(l7);
       
       
       JLabel l3 = new JLabel("Harvey Spectre");
       l3.setFont(new Font("SAN_SERIF", Font.BOLD, 15));
       l3.setForeground(Color.WHITE);
       l3.setBounds(110, 15, 120, 15);
       p1.add(l3);   
       ...
       a1 = new JPanel();
       //a1.setBounds(5, 75, 440, 358);
       a1.setFont(new Font("SAN_SERIF", Font.PLAIN, 17));
       //f1.add(a1);
       
       JScrollPane sp = new JScrollPane(a1);
       sp.setBounds(5, 75, 440, 358);
    ...
    public static JPanel formatLabel(String out){
        ...
        JLabel l1 = new JLabel("<html><p style = \"width : 75px\">"+out+"</p></html>");
        l1.setFont(new Font("Tahoma", Font.PLAIN, 16));
        l1.setBackground(new Color(37, 211, 102));
        l1.setOpaque(true);
        l1.setBorder(new EmptyBorder(5,5,5,10));
    ...
    public static void main(String[] args){
        new Servers().f1.setVisible(true);
